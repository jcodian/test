...
"use strict";
	...
	$(".tab-pane").elevateZoom({constrainType:"height", constrainSize:274, zoomType: "lens", containLensZoom: true, gallery:'gallery_01', cursor: 'pointer', galleryActiveClass: "active"}); 

	//pass the images to Fancybox
	$(".tab-pane").bind("click", function(e) {  
	  var ez =   $('.tab-pane').data('elevateZoom');	
